...
class Editor extends React.Component {
  ...
  render() {
    return /*#__PURE__*/(
      React.createElement("textarea", { id: "editor", value: this.props.content, onChange: this.props.handleTextAreaChange }));
...
![freeCodeCamp Logo](https://cdn.freecodecamp.org/testable-projects-fcc/images/fcc_secondary.svg)
  ...
  render() {
    return /*#__PURE__*/(
      ...
      React.createElement(Editor, { content: this.state.input, handleTextAreaChange: this.handleChange })), /*#__PURE__*/

      React.createElement("div", { class: "col-md-6" }, /*#__PURE__*/
      React.createElement(Previewer, { display: this.state.input }))));
